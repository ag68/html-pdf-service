...
public class TestDataProviderImpl implements TestDataProvider {
    ...
    private String getSimpleImageUrl() {
        ...
        sb.append("<p><img alt=\"\" src=\"https://spread.kxz.kaixinzu.shop/static/img/button.50960467.png\"/></p>");
        return sb.toString();
    }

    private String getSimpleQuotesWithImageUrl() {
        StringBuffer sb = new StringBuffer();
        sb.append("<p><img alt=\"\" src=\"https://spread.kxz.kaixinzu.shop/static/img/button.50960467.png\" /> <h1>January Announcement</h1></p>");
        sb.append("<p>Good morning everyone, just a gentle reminder that we lost everything just like every January.<br/> And now the CEO is going crazy. </p>");
        sb.append("<p><strong>Quotes all around (Gibrish): </strong></p>");
        sb.append("<p><strong>Nina Myers:&nbsp;</strong>He is gonna put a bullet in my head before I can say hello, and then he'll turn the gun on himself. Don&#39;t change any audit numbers even in decimals. Every thing must be accounted for. Not a single dime should be out of place. All sale records <h3>must</h3> be closed by 26th Dec.</p>");
        sb.append("<p>Sarah Conor: Watching John with the machine, it was suddenly so clear. The terminator, would never stop. It would never leave him, and it would never hurt him, never shout at him, or get drunk and hit him, or say it was too busy to spend time with him. It would always be there. And it would die, to protect him. Of all the would-be fathers who came and went over the years, this thing, this machine, was the only one who measured up. In an insane world, it was the sanest choice. </p>");
        sb.append("<p><strong>George Mason:&nbsp;</strong>Believe it or not, I used to want to be a teacher. A long time ago. You know why I didn't? DOD offered me more money. That's how I made my decision. So I made myself miserable. And I made everybody else around me miserable. For an extra five thousand dollars a year. That was my price. </p>");
        sb.append("<p>Tom, don't let anybody kid you. It's all personal, every bit of business. Every piece of shit every man has to eat every day of his life is personal. They call it business. OK. But it's personal as hell. You know where I learned that from? The Don. My old man. The Godfather. If a bolt of lightning hit a friend of his the old man would take it personal. He took my going into the Marines personal. That's what makes him great. The Great Don. He takes everything personal Like God. He knows every feather that falls from the tail of a sparrow or however the hell it goes? Right? And you know something? Accidents don't happen to people who take accidents as a personal insult..</p>");
    ...
    private String getSimpleThreateningLetter() {
        ...
        sb.append("<p>This letter wishes to bring your attention towards your non-payment of charges associated with using our services. ");
    ...
    private String getJsonDataArrayMultipleSignatures() {
        StringBuffer sb = new StringBuffer();
        sb.append("[");
        sb.append("{\"name\":{\"first\":\"Nina\",\"last\":\"Myers\"},\"fullName\": \"Nina Myers\",\"signatures\": [{\"name\":\"Jack Bauer\", \"designation\":\"The Boss\"}, {\"name\":\"Jack & Jill\", \"designation\":\"Customer Relationship Manager\"}]}");
        sb.append(",");
        sb.append("{\"name\":{\"first\":\"John\",\"last\":\"Doe\"},\"fullName\": \"John Doe\",\"signatures\": [{\"name\":\"Ethan Hunt\", \"designation\":\"Impossible Mission Force\"}, {\"name\":\"Michael Corleone\", \"designation\":\"The Reasoning Department\"}]}");
        sb.append(",");
        sb.append("{\"name\":{\"first\":\"Richard\",\"last\":\"Roe\"},\"fullName\": \"Richard Roe\",\"signatures\": [{\"name\":\"Fredo Corleone\", \"designation\":\"The Useless Department\"}]}");
        sb.append("]");
        return sb.toString();
    }
}
